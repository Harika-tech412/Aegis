/**
 * BorderGlow — React Bits (reactbits.dev/components/border-glow), adapted.
 *
 * Adaptations for Aegis:
 *  - TypeScript props.
 *  - The docs' purple/pink/cyan `colors` default is replaced with our
 *    restrained danger red, because here the glow CARRIES MEANING: it appears
 *    only on AUTO_FLAG cases. It is a risk signal, not decoration.
 *  - `animated` is left off by default and the sweep is opt-in, per the
 *    component's own guidance around restraint.
 *
 * Used on EXACTLY ONE surface, conditionally: the Decision Summary card when
...
export default function BorderGlow({
  ...
  useEffect(() => {
    ...
    // Honour reduced-motion: skip the intro sweep entirely.
